...
public class CfpLoginUsernamePasswordAuthUser  extends
     ...
     * @param email
     */
    public CfpLoginUsernamePasswordAuthUser(final String email) {
        this(null, email);
    }

    public CfpLoginUsernamePasswordAuthUser(final String clearPassword,
                                           final String email) {
